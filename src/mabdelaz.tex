...
\cvsite{\myhy{https://github.com/iocoder}{https://github.com/iocoder}}
...
\aboutme{Computer software engineer with wide technical expertise in computer networks,
         low-level programming, embedded systems, database systems, and computer architecture.\\
         %\vspace{10px}
