...
\aboutme{I am a Computer Engineer specialized in Network Systems, Low-Level Programming,
...
\ospref{
    \textcolor{black}{
    \textbf{Linux Kernel}\hfill\includegraphics[scale=0.40]{5stars.png}\newline
    \textbf{x86, x64, arm64, AVR, PIC}\hfill\includegraphics[scale=0.40]{5stars.png}\newline
    \textbf{TCP/IP Networks}\hfill\includegraphics[scale=0.40]{5stars.png}\newline
    \textbf{Altera/Xilinx FPGAs}\hfill\includegraphics[scale=0.40]{5stars.png}\newline
    \textbf{Windows Kernel API}\hfill\includegraphics[scale=0.40]{3stars.png}}}
